        ...
        SubShader
    {
        ...
        Pass
        {
            ...
            void geom(triangle v2g IN[3], inout TriangleStream<g2f> triStream)
            {
                ...
                float pulse = sin(_Time.y * _Speed + IN[0].vertex.y * _Freq);

                float4 vtxCentre = ((IN[0].vertex + IN[1].vertex + IN[2].vertex) / 3.0f) + float4(normal,0) * _Extrusion * pulse;
